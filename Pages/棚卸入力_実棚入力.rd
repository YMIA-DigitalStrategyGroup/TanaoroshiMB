{
  ...
  "Formulas": {
    ...
    "13,5": "IF(OR(F14=\"\",ISERROR(Y19)),\"0\",Y19)",
    "15,24": "NOW()",
    "18,24": "ODATA(\"ymia_t_tanaoroshi_datainput?$select=TANA_SU&$filter=TARGET_YEAR_MONTH eq \"&IF(ISBLANK(F2),\"null\",\"'\"&F2&\"'\")&\" and TANABAN eq \"&IF(ISBLANK(F4),\"null\",\"'\"&F4&\"'\")&\" and HINBAN eq \"&IF(ISBLANK(F7),\"null\",\"'\"&F7&\"'\"))"
  }
}